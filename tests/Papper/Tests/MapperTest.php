...
use Papper\Internal\Reflector\Reflector;
use Papper\Internal\TypeMap;
...
class MapperTest extends TestCaseBase
{
	...
	{
		return new TypeMap($this->createReflector($sourceClass), $this->createReflector($destinationClass));
	}
